    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <h1 class="display-3">Join Now</h1>
                ...
                <button class="btn btn-outline-light btn-lg" type="button">Sing Up</button>
...
<?php
  ...
  global $conn;
    $get_book="select * from books where book_keyword like '%$search_query%' or book_title like '%$search_query%' or book_author like '%$search_query%'";
